...
public class MockWebServerRule implements TestRule {
  ...
  @NonNull private final Object testClassInstance;
      ...
      @Override public void evaluate() throws Throwable {
        ...
        if (needsMockWebServer != null) {
          ...
          if (!needsMockWebServer.setupMethod().isEmpty()) {
            final Method setupMethod = testClassInstance.getClass()
                .getDeclaredMethod(needsMockWebServer.setupMethod(), MockWebServer.class);
