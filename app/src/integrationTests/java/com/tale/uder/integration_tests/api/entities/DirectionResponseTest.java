...
@RunWith(UderIntegrationRobolectricTestRunner.class) public class DirectionResponseTest {
  ...
  @Test public void fromJson() throws IOException {
    ...
    DirectionResponse item = objectMapper.readValue(SAMPLE_RESPONSE, DirectionResponse.class);

    assertThat(item.routes).hasSize(1);
    final Route route = item.routes.get(0);
    assertThat(route.legs).hasSize(1);
    final Leg leg = route.legs.get(0);
    assertThat(leg.steps).hasSize(13);
  }
}
