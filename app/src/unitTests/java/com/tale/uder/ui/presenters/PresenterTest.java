...
public class PresenterTest {
  ...
  @NonNull private Presenter<Object> presenter;

  @SuppressWarnings("NullableProblems") // Initialized in @Before.
  @NonNull private Object view;
  ...
  @Test public void bindView_shouldAttachViewToThePresenter() {
    presenter.bindView(view);
    assertThat(presenter.view()).isSameAs(view);
  }

  @Test public void bindView_shouldThrowIfPreviousViewIsNotUnbounded() {
    presenter.bindView(view);
  ...
  @Test public void unsubscribeOnUnbindView_shouldWorkAccordingItsContract() {
    presenter.bindView(view);
  ...
  @Test public void unbindView_shouldNullTheViewReference() {
    presenter.bindView(view);
    assertThat(presenter.view()).isSameAs(view);
  ...
  @Test public void unbindView_shouldThrowIfPreviousViewIsNotSameAsExpected() {
    presenter.bindView(view);
    ...
    try {
      ...
      assertThat(expected).hasMessage(
          "Unexpected view! previousView = " + view + ", view to unbind = " + unexpectedView);
    }
  }
}