...
@RunWith(UderRobolectricUnitTestRunner.class) public class DeveloperSettingsTest {
  ...
  @Before public void beforeEachTest() {
    developerSettings = new DeveloperSettings(
        RuntimeEnvironment.application.getSharedPreferences("developer_settings", MODE_PRIVATE));
  }

  @Test public void isStethoEnabled_shouldReturnFalseByDefault() {
    assertThat(developerSettings.isStethoEnabled()).isFalse();
  }

  @Test public void saveIsStethoEnabled_isStethoEnabled() {
  ...
  @Test public void isLeakCanaryEnabled_shouldReturnFalseByDefault() {
    assertThat(developerSettings.isLeakCanaryEnabled()).isFalse();
  }

  @Test public void saveIsLeakCanaryEnabled_isLeakCanaryEnabled() {
  ...
  @Test public void isTinyDancerEnabled_shouldReturnFalseByDefault() {
    assertThat(developerSettings.isTinyDancerEnabled()).isFalse();
  }

  @Test public void saveIsTinyDancerEnabled_isTinyDancerEnabled() {
  ...
  @Test public void getHttpLoggingLevel_shouldReturnBaseByDefault() {
    assertThat(developerSettings.getHttpLoggingLevel()).isEqualTo(
        HttpLoggingInterceptor.Level.BASIC);
  }

  @Test public void saveHttpLoggingLevel_getHttpLoggingLevel() {
