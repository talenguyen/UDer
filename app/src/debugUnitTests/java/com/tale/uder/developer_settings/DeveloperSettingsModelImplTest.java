...
public class DeveloperSettingsModelImplTest {
  ...
  @SuppressWarnings("NullableProblems") // Initialized in @Before.
  @NonNull private DeveloperSettings developerSettings;

  @Before public void beforeEachTest() {
    developerSettings = mock(DeveloperSettings.class);
    developerSettingsModel =
        new DeveloperSettingsModelImpl(mock(UderApp.class), developerSettings,
            mock(OkHttpClient.class), new HttpLoggingInterceptor(), mock(LeakCanaryProxy.class));
  }

  @Test public void getGitSha_shouldNotBeNull() {
  ...
  @Test public void getGitSha_shouldReturnSameResultForSeveralCalls() {
  ...
  @Test public void getBuildDate_shouldNotBeNull() {
  ...
  @Test public void getBuildDate_shouldReturnSameResultForSeveralCalls() {
  ...
  @Test public void getBuildVersionCode_shouldNotBeNull() {
    assertThat(developerSettingsModel.getBuildVersionCode()).isNotNull();
  }

  @Test public void getBuildVersionCode_shouldReturnSameResultForSeveralCalls() {
  ...
  @Test public void getBuildVersionName_shouldNotBeNull() {
    assertThat(developerSettingsModel.getBuildVersionName()).isNotNull();
  }

  @Test public void getBuildVersionName_shouldReturnSameResultForSeveralCalls() {
  ...
  @Test public void isStethoEnabled_shouldReturnValueFromDeveloperSettings() {
  ...
  @Test public void isLeakCanaryEnabled_shouldReturnValueFromDeveloperSettings() {
  ...
  @Test public void isTinyDancerEnabled_shouldReturnValueFromDeveloperSettings() {
