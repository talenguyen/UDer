...
public class DeveloperSettingsPresenterTest {
  ...
  @NonNull private DeveloperSettingsModelImpl developerSettingsModel;

  @SuppressWarnings("NullableProblems") // Initialized in @Before.
  @NonNull private DeveloperSettingsPresenter developerSettingsPresenter;

  @SuppressWarnings("NullableProblems") // Initialized in @Before.
  @NonNull private DeveloperSettingsView developerSettingsView;

  @Before public void beforeEachTest() {
    developerSettingsModel = mock(DeveloperSettingsModelImpl.class);
    developerSettingsPresenter =
        new DeveloperSettingsPresenter(developerSettingsModel, mock(AnalyticsModel.class));
    developerSettingsView = mock(DeveloperSettingsView.class);
  }

  @Test public void bindView_shouldSendGitShaToTheView() {
  ...
  @Test public void bindView_shouldSendBuildDateToTheView() {
  ...
  @Test public void bindView_shouldSendBuildVersionCodeToTheView() {
  ...
  @Test public void bindView_shouldSendBuildVersionNameToTheView() {
  ...
  @Test public void bindView_shouldSendStethoEnabledStateToTheView() {
  ...
  @Test public void bindView_shouldSendStethoDisabledStateToTheView() {
  ...
  @Test public void bindView_shouldSendLeakCanaryEnabledStateToTheView() {
  ...
  @Test public void bindView_shouldSendLeakCanaryDisabledStateToTheView() {
  ...
  @Test public void bindView_shouldSendTinyDancerEnabledStateToTheView() {
  ...
  @Test public void bindView_shouldSendTinyDancerDisabledStateToTheView() {
  ...
  @Test public void bindView_shouldSendHttpLoggingLevelToTheView() {
  ...
  @Test public void changeStethoState_shouldNoOpIfStateAlreadySameAndEnabled() {
    when(developerSettingsModel.isStethoEnabled()).thenReturn(true);
  ...
  @Test public void changeLeakCanaryState_shouldNoOpIfStateAlreadySameAndEnabled() {
    when(developerSettingsModel.isLeakCanaryEnabled()).thenReturn(true);
  ...
  @Test public void changeLeakCanaryState_shouldDisableLeakCanaryAndNotifyView() {
    developerSettingsPresenter.bindView(developerSettingsView);
  ...
  @Test public void changeTinyDancerState_shouldNoOpIfStateAlreadySameAndEnabled() {
    when(developerSettingsModel.isTinyDancerEnabled()).thenReturn(true);
  ...
  @Test public void changeTinyDancerState_shouldEnableTinyDancerAndNotifyView() {
    developerSettingsPresenter.bindView(developerSettingsView);
  ...
  @Test public void changeHttpLoggingLevel_shouldChangeLevelAndNotifyView() {
    for (HttpLoggingInterceptor.Level loggingLevel : HttpLoggingInterceptor.Level.values()) {
      ...
      verify(developerSettingsView).showMessage(
          "Http logging level was changed to " + loggingLevel.toString());
