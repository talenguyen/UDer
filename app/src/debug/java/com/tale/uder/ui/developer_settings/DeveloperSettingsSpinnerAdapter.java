...
public class DeveloperSettingsSpinnerAdapter<T extends DeveloperSettingsSpinnerAdapter.SelectionOption>
    extends BaseAdapter {

  @NonNull private final LayoutInflater layoutInflater;
  @NonNull private List<T> selectionOptions = emptyList();

  public DeveloperSettingsSpinnerAdapter(@NonNull LayoutInflater layoutInflater) {
    this.layoutInflater = layoutInflater;
  }

  public DeveloperSettingsSpinnerAdapter<T> setSelectionOptions(
      @NonNull List<? extends T> selectionOptions) {
  ...
  @Override @NonNull public T getItem(int position) {
  ...
  public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ...
    if (convertView == null) {
      convertView =
          layoutInflater.inflate(R.layout.list_developer_settings_spinner_item, parent, false);
  ...
  public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ...
    if (convertView == null) {
      convertView =
          layoutInflater.inflate(R.layout.list_developer_settings_spinner_drop_down_item, parent,
              false);
      viewHolder = new ViewHolder(convertView);
      convertView.setTag(viewHolder);
    } else {
  ...
  static class ViewHolder {
    ...
    public ViewHolder(@NonNull View itemView) {
      titleTextView = (TextView) itemView.findViewById(
          R.id.list_developer_settings_spinner_item_title_text_view);
    }
