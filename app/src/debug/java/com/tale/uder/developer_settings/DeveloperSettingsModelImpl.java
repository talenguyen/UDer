...
public class DeveloperSettingsModelImpl implements DeveloperSettingModel {
  ...
  @NonNull private final DeveloperSettings developerSettings;

  @NonNull private final OkHttpClient okHttpClient;

  @NonNull private final HttpLoggingInterceptor httpLoggingInterceptor;

  @NonNull private final LeakCanaryProxy leakCanaryProxy;

  @NonNull private AtomicBoolean stethoAlreadyEnabled = new AtomicBoolean();

  @NonNull private AtomicBoolean leakCanaryAlreadyEnabled = new AtomicBoolean();

  @NonNull private AtomicBoolean tinyDancerDisplayed = new AtomicBoolean();

  public DeveloperSettingsModelImpl(@NonNull UderApp uderApp,
      @NonNull DeveloperSettings developerSettings, @NonNull OkHttpClient okHttpClient,
  ...
  @NonNull public String getGitSha() {
  ...
  @NonNull public String getBuildVersionCode() {
    return String.valueOf(BuildConfig.VERSION_CODE);
  }

  @NonNull public String getBuildVersionName() {
  ...
  @NonNull public HttpLoggingInterceptor.Level getHttpLoggingLevel() {
  ...
  @Override public void apply() {
    ...
    if (stethoAlreadyEnabled.compareAndSet(false, true)) {
      if (isStethoEnabled()) {
        Stetho.initializeWithDefaults(uderApp);
    ...
    if (isTinyDancerEnabled() && tinyDancerDisplayed.compareAndSet(false, true)) {
      final DisplayMetrics displayMetrics = uderApp.getResources().getDisplayMetrics();
